    ...
    try {
      ...
      const prompt = `
        ...
        Chỉ trả về đối tượng JSON hợp lệ với cấu trúc CHÍNH XÁC sau (không giải thích hay văn bản khác):
        {
          ...
          "anthropometryData": {
            "faceRatio": "Phân tích chi tiết về tỷ lệ khuôn mặt dựa trên tỷ lệ vàng, độ cân đối chiều dài/chiều rộng khuôn mặt, tỷ lệ 1:1.618 và ý nghĩa khoa học của nó đối với sự hài hòa trong khuôn mặt người Việt Nam. Phân tích xem tỷ lệ này ảnh hưởng thế nào đến tính cách, sức khỏe và vận mệnh.",
            "symmetryIndex": "Phân tích chi tiết về mức độ cân đối hai bên khuôn mặt, độ lệch giữa bên trái và bên phải, tính đến các đặc điểm như mắt, lông mày, mũi, miệng có đối xứng không và ý nghĩa của sự cân đối này về mặt nhân tướng học. Đưa ra nhận xét về sự hài hòa tổng thể và ảnh hưởng đến tâm lý, vận mệnh.",
            "faceShape": "Phân tích chi tiết về hình dáng khuôn mặt, xem thuộc dạng nào (tròn, vuông, oval, trái xoan, trái tim, kim cương, tam giác...). Xác định khuôn mặt có cân đối theo tỷ lệ chuẩn người Việt Nam không. Phân tích ý nghĩa của hình dáng khuôn mặt đối với tính cách, vận mệnh và điểm mạnh, điểm yếu trong cuộc sống.",
            "eyeDistance": "Phân tích chi tiết về khoảng cách giữa hai mắt, xem có phù hợp với tỷ lệ chuẩn theo nhân trắc học Việt Nam không (khoảng cách giữa hai mắt thường bằng chiều rộng của một mắt). Phân tích ý nghĩa của khoảng cách này về tính cách, trí tuệ, sự nhạy cảm và khả năng quan sát.",
            "noseRatio": "Phân tích chi tiết về tỷ lệ của mũi so với các đặc điểm khác trên khuôn mặt trong bối cảnh người Việt Nam, bao gồm chiều dài, độ rộng, độ cao sống mũi, kích thước cánh mũi. Phân tích mũi có cao thẳng, dài, cân đối không và ý nghĩa của nó đối với tài lộc, sức khỏe, và khả năng lãnh đạo.",
            "faceBoneStructure": "Phân tích chi tiết về cấu trúc xương mặt của người dùng, bao gồm xương gò má và xương hàm, xương cằm. Đánh giá sự nổi bật, cân đối và tính thẩm mỹ của các cấu trúc xương này. Phân tích ý nghĩa của cấu trúc xương mặt đối với sức khỏe, tính cách và nét hấp dẫn của khuôn mặt từ góc độ nhân trắc học.",
          },
          "anthropometryScores": {
          ...
          "faceReading": {
            "eyesAnalysis": "Phân tích chi tiết về đôi mắt theo nhân tướng học Việt Nam bao gồm kích thước, hình dạng, độ sáng, màu mắt, độ cong của đuôi mắt, khoảng cách giữa hai mắt, và ý nghĩa của nó đối với tính cách, trí tuệ, cảm xúc và vận mệnh. Phân tích đôi mắt có tốt không, có thể hiện sự chân thành, sáng suốt không.",
            "noseAnalysis": "Phân tích chi tiết về mũi theo nhân tướng học Việt Nam bao gồm chiều dài, độ cao, độ rộng của sống mũi và cánh mũi, hình dạng đầu mũi, và ý nghĩa của nó đối với tài chính, sức khỏe, sự nghiệp và vận mệnh. Phân tích mũi có mang lại tài lộc, thăng tiến không.",
            "mouthAnalysis": "Phân tích chi tiết về miệng và môi theo nhân tướng học Việt Nam bao gồm kích thước, hình dạng, độ dày của môi, màu sắc, đường cong của miệng khi cười, và ý nghĩa của nó đối với tính cách, khả năng giao tiếp, các mối quan hệ và vận mệnh. Phân tích miệng có khéo léo, có mang lại thành công trong giao tiếp không.",
            "foreheadAnalysis": "Phân tích chi tiết về trán theo nhân tướng học Việt Nam bao gồm chiều cao, độ rộng, đường viền tóc, các đường vân trên trán, và ý nghĩa của nó đối với trí tuệ, khả năng lập kế hoạch, và cơ hội trong sự nghiệp. Phân tích trán có rộng, cao, báo hiệu sự thông minh và tài năng không.",
            "eyebrowsAnalysis": "Phân tích chi tiết về lông mày theo nhân tướng học Việt Nam bao gồm hình dạng, độ dày, độ cong, khoảng cách giữa hai lông mày, màu sắc, và ý nghĩa của nó đối với tính cách, sự nghiệp, và các mối quan hệ. Phân tích lông mày có cân đối, đẹp, báo hiệu vận may không.",
            "chinAnalysis": "Phân tích chi tiết về cằm theo nhân tướng học Việt Nam bao gồm kích thước, hình dạng, độ nhọn, độ rộng, và ý nghĩa của nó đối với tính cách, ý chí, sự kiên định và vận mệnh. Phân tích cằm có mạnh mẽ, cân đối không, có mang đến sự thành công và ổn định không."
          },
          "faceReadingScores": {
          ...
          "physiognomy": {
            "future": "Phân tích chi tiết về tương lai dựa trên nhân tướng học Việt Nam, bao gồm những dự đoán về sự phát triển cá nhân, những cơ hội và thách thức sắp tới trong 5-10 năm tới. Phân tích những thay đổi lớn trong cuộc sống, sự nghiệp, tình cảm và vị thế xã hội mà người này có thể trải qua.",
            ...
            "relationships": "Phân tích chi tiết về các mối quan hệ xã hội dựa trên nhân tướng học Việt Nam, bao gồm các mối quan hệ gia đình, bạn bè và đồng nghiệp. Phân tích người này có khả năng tạo dựng mạng lưới quan hệ rộng không, có khả năng hòa nhập với nhóm không, có được sự tín nhiệm của người khác không.",
            "romance": "Phân tích chi tiết về đời sống tình cảm dựa trên nhân tướng học Việt Nam, bao gồm tình yêu, hôn nhân và các mối quan hệ thân mật. Phân tích người này có dễ thu hút tình cảm không, có thành công trong hôn nhân không, có khả năng xây dựng mối quan hệ bền vững không.",
            "career": "Phân tích chi tiết về sự nghiệp dựa trên nhân tướng học Việt Nam, bao gồm nghề nghiệp phù hợp, khả năng thăng tiến, phong cách làm việc, và những thách thức trong công việc. Phân tích người này phù hợp với nghề nào, có khả năng đạt được thành công lớn trong sự nghiệp không.",
            "wisdom": "Phân tích chi tiết về trí tuệ dựa trên nhân tướng học Việt Nam, bao gồm IQ, EQ, trực giác, khả năng học tập và áp dụng kiến thức. Phân tích người này có thông minh, có khả năng ghi nhớ tốt, có khả năng sáng tạo không."
          },
          "physiognomyScores": {
          ...
          "overallEvaluation": {
            "appearance": "Phân tích chi tiết về ngoại hình tổng thể của người này, bao gồm đặc điểm khuôn mặt, vẻ đẹp tổng thể, và ấn tượng đầu tiên mà họ tạo ra cho người khác. Đánh giá về sự hài hòa và cân đối, những nét độc đáo và đặc biệt trong ngoại hình.",
            "personality": "Phân tích chi tiết về tính cách dựa trên nhân tướng học Việt Nam, bao gồm đặc điểm tâm lý, cách ứng xử và giải quyết vấn đề. Phân tích người này có tính cách thế nào, có phù hợp với vị trí lãnh đạo không.",
            "strengths": "Liệt kê và phân tích chi tiết những điểm mạnh nổi bật trong tính cách và khả năng của người này, dựa trên các đặc điểm khuôn mặt. Giải thích cách những điểm mạnh này có thể giúp họ thành công trong công việc và cuộc sống.",
            "weaknesses": "Liệt kê và phân tích chi tiết những điểm yếu hoặc thách thức trong tính cách và cách cư xử của người này, dựa trên các đặc điểm khuôn mặt. Đề xuất cách họ có thể khắc phục hoặc cân bằng những điểm yếu này.",
            "interests": "Phân tích những sở thích và đam mê tiềm năng của người này dựa trên đặc điểm khuôn mặt và biểu hiện trong ảnh. Gợi ý các hoạt động, lĩnh vực nghề nghiệp hoặc sở thích có thể phù hợp với họ.",
            "lifestyle": "Phân tích phong cách sống phù hợp với đặc điểm khuôn mặt của người này, bao gồm môi trường sống, làm việc lý tưởng, cách quản lý thời gian và nguồn lực, và những thói quen có thể giúp họ phát huy tối đa tiềm năng."
          },
