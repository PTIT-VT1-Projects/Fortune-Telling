    ...
    try {
      ...
      const prompt = `
        ...
        Chỉ trả về đối tượng JSON hợp lệ với cấu trúc CHÍNH XÁC sau (không giải thích hay văn bản khác):
        {
          ...
          "faceReading": {
            "eyesAnalysis": "Phân tích chi tiết về đôi mắt theo nhân tướng học Việt Nam bao gồm kích thước, hình dạng, độ sáng, màu mắt, độ cong của đuôi mắt, khoảng cách giữa hai mắt, và ý nghĩa của nó đối với tính cách, trí tuệ, cảm xúc và vận mệnh. Phân tích đôi mắt có tốt không, có thể hiện sự chân thành, sáng suốt không. Viết trong 3 câu",
            "noseAnalysis": "Phân tích chi tiết về mũi theo nhân tướng học Việt Nam bao gồm chiều dài, độ cao, độ rộng của sống mũi và cánh mũi, hình dạng đầu mũi, và ý nghĩa của nó đối với tài chính, sức khỏe, sự nghiệp và vận mệnh. Phân tích mũi có mang lại tài lộc, thăng tiến không. Viết trong 3 câu",
            "mouthAnalysis": "Phân tích chi tiết về miệng và môi theo nhân tướng học Việt Nam bao gồm kích thước, hình dạng, độ dày của môi, màu sắc, đường cong của miệng khi cười, và ý nghĩa của nó đối với tính cách, khả năng giao tiếp, các mối quan hệ và vận mệnh. Phân tích miệng có khéo léo, có mang lại thành công trong giao tiếp không. Viết trong 3 câu",
            "foreheadAnalysis": "Phân tích chi tiết về trán theo nhân tướng học Việt Nam bao gồm chiều cao, độ rộng, đường viền tóc, các đường vân trên trán, và ý nghĩa của nó đối với trí tuệ, khả năng lập kế hoạch, và cơ hội trong sự nghiệp. Phân tích trán có rộng, cao, báo hiệu sự thông minh và tài năng không. Viết trong 3 câu",
            "eyebrowsAnalysis": "Phân tích chi tiết về lông mày theo nhân tướng học Việt Nam bao gồm hình dạng, độ dày, độ cong, khoảng cách giữa hai lông mày, màu sắc, và ý nghĩa của nó đối với tính cách, sự nghiệp, và các mối quan hệ. Phân tích lông mày có cân đối, đẹp, báo hiệu vận may không. Viết trong 3 câu",
            "chinAnalysis": "Phân tích chi tiết về cằm theo nhân tướng học Việt Nam bao gồm kích thước, hình dạng, độ nhọn, độ rộng, và ý nghĩa của nó đối với tính cách, ý chí, sự kiên định và vận mệnh. Phân tích cằm có mạnh mẽ, cân đối không, có mang đến sự thành công và ổn định không. Viết trong 3 câu"
          },
          "faceReadingScores": {
          ...
          "physiognomy": {
            "future": "Phân tích chi tiết về tương lai dựa trên nhân tướng học Việt Nam, bao gồm những dự đoán về sự phát triển cá nhân, những cơ hội và thách thức sắp tới trong 5-10 năm tới. Phân tích những thay đổi lớn trong cuộc sống, sự nghiệp, tình cảm và vị thế xã hội mà người này có thể trải qua. Viết trong 3 câu",
            ...
            "relationships": "Phân tích chi tiết về các mối quan hệ xã hội dựa trên nhân tướng học Việt Nam, bao gồm các mối quan hệ gia đình, bạn bè và đồng nghiệp. Phân tích người này có khả năng tạo dựng mạng lưới quan hệ rộng không, có khả năng hòa nhập với nhóm không, có được sự tín nhiệm của người khác không. Viết trong 3 câu",
            "romance": "Phân tích chi tiết về đời sống tình cảm dựa trên nhân tướng học Việt Nam, bao gồm tình yêu, hôn nhân và các mối quan hệ thân mật. Phân tích người này có dễ thu hút tình cảm không, có thành công trong hôn nhân không, có khả năng xây dựng mối quan hệ bền vững không. Viết trong 3 câu",
            "career": "Phân tích chi tiết về sự nghiệp dựa trên nhân tướng học Việt Nam, bao gồm nghề nghiệp phù hợp, khả năng thăng tiến, phong cách làm việc, và những thách thức trong công việc. Phân tích người này phù hợp với nghề nào, có khả năng đạt được thành công lớn trong sự nghiệp không. Viết trong 3 câu",
            "wisdom": "Phân tích chi tiết về trí tuệ dựa trên nhân tướng học Việt Nam, bao gồm IQ, EQ, trực giác, khả năng học tập và áp dụng kiến thức. Phân tích người này có thông minh, có khả năng ghi nhớ tốt, có khả năng sáng tạo không. Viết trong 3 câu"
          },
          "physiognomyScores": {
          ...
          "overallEvaluation": {
            "appearance": "Phân tích chi tiết về ngoại hình tổng thể của người này, bao gồm đặc điểm khuôn mặt, vẻ đẹp tổng thể, và ấn tượng đầu tiên mà họ tạo ra cho người khác. Đánh giá về sự hài hòa và cân đối, những nét độc đáo và đặc biệt trong ngoại hình. Viết trong 3 câu",
            "personality": "Phân tích chi tiết về tính cách dựa trên nhân tướng học Việt Nam, bao gồm đặc điểm tâm lý, cách ứng xử và giải quyết vấn đề. Phân tích người này có tính cách thế nào, có phù hợp với vị trí lãnh đạo không. Viết trong 3 câu",
            "strengths": "Liệt kê và phân tích chi tiết những điểm mạnh nổi bật trong tính cách và khả năng của người này, dựa trên các đặc điểm khuôn mặt. Giải thích cách những điểm mạnh này có thể giúp họ thành công trong công việc và cuộc sống. Viết trong 3 câu",
            "weaknesses": "Liệt kê và phân tích chi tiết những điểm yếu hoặc thách thức trong tính cách và cách cư xử của người này, dựa trên các đặc điểm khuôn mặt. Đề xuất cách họ có thể khắc phục hoặc cân bằng những điểm yếu này. Viết trong 3 câu",
            "interests": "Phân tích những sở thích và đam mê tiềm năng của người này dựa trên đặc điểm khuôn mặt và biểu hiện trong ảnh. Gợi ý các hoạt động, lĩnh vực nghề nghiệp hoặc sở thích có thể phù hợp với họ. Viết trong 3 câu",
            "lifestyle": "Phân tích phong cách sống phù hợp với đặc điểm khuôn mặt của người này, bao gồm môi trường sống, làm việc lý tưởng, cách quản lý thời gian và nguồn lực, và những thói quen có thể giúp họ phát huy tối đa tiềm năng. Viết trong 3 câu"
          },
