    ...
    return (
        <div ref={ref}>
            <div className='d-flex justify-content-between align-items-center ms-3 me-3'>
                <img src='/images/ptit.png' alt='ptit' width={130} height={130} className='mt-2'/>
                <div>
                    <p>Học viện Công nghệ Bưu chính Viễn thông</p>
                    <p className='text-center'>Khoa Viễn thông 1</p>
                </div>
                <img src='/images/vt1.png' alt='ptit' width={130} height={130} className='mt-2'/>
            </div>
            ...
            <div className='ml-3 mr-3 d-flex justify-content-center'>
                ...
                <div className="row mt-4 me-3">
                    <div className='col-6'>
                        <RadarChart width={400} height={400} overallEvaluation={overallEvaluation} overallEvaluationScores={overallEvaluationScores}/>
                    </div>
                    <div className='col-6'>
