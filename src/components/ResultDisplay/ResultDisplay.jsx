...
import OverallEvaluation from "../tabs/OverallEvaluation";
...
const ResultDisplay = ({ image, faceData, onUploadNew, loading }) => {
  ...
  const calculateOverallScore = useCallback((data) => {
    ...
    const featureWeights = [
      ...
      { source: "faceReadingScores", key: "nose", weight: 0.1 },
  ...
  const getRatingFromScore = useCallback(
    (score) => {
      ...
      if (age < 12) {
        switch (roundedScore) {
          case 10:
            return "Vô cùng dễ thương";
          case 9:
            return "Cực kỳ dễ thương";
          case 8:
            return "Rất dễ thương";
          case 7:
            return "Dễ thương";
          case 6:
            return "Khá dễ thương";
          case 5:
            return "Dễ mến";
          case 4:
            return "Bình thường";
          case 3:
            return "Hơi kém hài hòa";
          case 2:
            return "Hơi thiếu nét dễ thương";
          case 1:
            return "Ít nét dễ thương";
          default:
      ...
      if (age >= 30 && age < 50) {
        if (isMale) {
          ...
          switch (roundedScore) {
            case 10:
              return "Cực kỳ thanh lịch";
            case 9:
              return "Rất thanh lịch";
            case 8:
              return "Thanh lịch";
            case 7:
              return "Khá thanh lịch";
            case 6:
              return "Nữ tính";
            case 5:
              return "Dịu dàng";
      ...
      if (age >= 50) {
        switch (roundedScore) {
          case 10:
            return isMale ? "Cực kỳ phúc hậu" : "Cực kỳ đằm thắm";
          case 9:
            return isMale ? "Rất phúc hậu" : "Rất đằm thắm";
          case 8:
            return isMale ? "Phúc hậu" : "Đằm thắm";
          case 7:
            return isMale ? "Khá phúc hậu" : "Khá đằm thắm";
          case 6:
            return isMale ? "Đáng kính" : "Đáng mến";
          case 5:
            return "Hiền hòa";
          case 4:
            return "Trung bình";
  ...
  const renderTabContent = (image) => {
    ...
    try {
      ...
      const hasBasicData =
        faceData.basicInfo && typeof faceData.basicInfo === "object";
      const hasFaceScore =
        typeof faceData.faceScore === "number" ||
        (faceData.faceReadingScores &&
          Object.keys(faceData.faceReadingScores).length > 0) ||
        (faceData.anthropometryScores &&
          Object.keys(faceData.anthropometryScores).length > 0);
      ...
      <div className="result-display">
        <div className="invalid-image-message">
          ...
          <p className="invalid-image-text">
            {error.replace("INVALID_PORTRAIT", "").trim() ||
              "Đây không phải là ảnh chân dung hợp lệ. Vui lòng upload ảnh khác."}
          </p>
        ...
        <div className="invalid-image-message">
          ...
          <p className="invalid-image-text">
            {error.includes("INVALID_PORTRAIT")
              ? error.replace("INVALID_PORTRAIT", "").trim() ||
                "Đây không phải là ảnh chân dung hợp lệ. Vui lòng tải lên ảnh khác."
              : error ||
                "Có lỗi xảy ra khi xử lý ảnh. Vui lòng thử lại với ảnh khác."}
          </p>
          <button className="analyze-again-button" onClick={handleUploadClick}>
            Tải lên ảnh mới
          </button>
  ...
  return (
    <div className="row">
      ...
      <div className="col-md-9">
        {/* Tab Content */}
        <div className="tab-content">{renderTabContent(image)}</div>
      </div>
    </div>
  );
};
